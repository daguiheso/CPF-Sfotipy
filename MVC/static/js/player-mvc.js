		...
		this.model.setSongs([
			{
				...
				artist: '8in8',
				src: '../static/media/8in8_-_05_-_Ill_Be_My_Mirror.mp3',
				img: '../static/img/songs/test.jpg'
			},
			{
				name: 'Floss Suffers From Gamma Radiation',
				artist: 'Blue Ducks',
				src: '../static/media/Blue_Ducks_-_01_-_Floss_Suffers_From_Gamma_Radiation.mp3',
				img: '../static/img/songs/test.jpg'
			},
			{
				name: 'IMF',
				artist: 'DOt',
				src: '..static/media/DOt_-_05_-_IMF.mp3',
				img: '../static/img/songs/test.jpg'
			}
		])
